...
- 3、  如果你想将自己的修改好的分支推到源仓库上你还需要再做一下操纵（如 下图）
     请注意一下几点：
     

     1)在你将自己修改的部分上传至自己的分支不妨先将git commit -m 后面的内容写**清楚**(暗示**语义化**)，在团队协做开发时可以方便管理员快速审核代码。
     ...
     [关于Git语义化 ★10+](https://zy68.top/2020/12/23/gitMessageStandard/) - (译)通过 Git 和 Angular 了解语义化提交信息

     例如：

![1621348680103.png](https://7.dusays.com/2021/05/18/f3986c22120b3.png)

  这样就可以使你的提交语义化了。😁😁

  接着打开你的fork分支，将你的修改推到源仓库。

![](https://7.dusays.com/2021/05/18/26b915138d434.png)
